...
export class InscripcionService {
  ...
  async create(id: number, user: UserInfoDto) {
    ...
    return {
      ...
      qrUrl: inscripcionGuardada.qrToken ? `${this.getBackendUrl()}/inscripcion/validar-qr/${inscripcionGuardada.qrToken}` : null,
  ...
  async findByUser(userId: number) {
    ...
    return inscripciones.map(inscripcion => {
      ...
      return {
        ...
        qrUrl: inscripcion.qrToken ? `${this.getBackendUrl()}/inscripcion/validar-qr/${inscripcion.qrToken}` : null,
  ...
  async findOne(inscripcionId: number, userId: number) {
    ...
    return {
      id: inscripcion.id,
      qrToken: inscripcion.qrToken,
      qrUrl: `${this.getBackendUrl()}/inscripcion/validar-qr/${inscripcion.qrToken}`,
      estado: inscripcion.estado,
      comprobantePago: inscripcion.comprobantePago,
      comprobantePagoVerificado: inscripcion.comprobantePagoVerificado,
      ingresado: inscripcion.ingresado,
  ...
  async subirComprobante(idLugar: number, userId: number, comprobante: Express.Multer.File) {
    ...
    const cloudinaryResult = await this.cloudinaryService.uploadImage(comprobante);
    inscripcion.comprobantePago = cloudinaryResult.secure_url;
